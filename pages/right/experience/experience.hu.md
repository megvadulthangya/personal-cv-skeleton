---
title: KIEMELT PROJEKTEK & TAPASZTALAT
...
experience:
  - date: 2025 - Jelenleg
    ...
    years: 1
    animation: fadeIn
    description: "<b>Meta-Projekt:</b> Ezt az önéletrajzot az általam fejlesztett és karbantartott szoftver generálja.<br><b>Frontend & UX:</b> A téma teljes újraírása (Refactoring), SCSS alapú Nord Color Palette és automatikus Dark/Light mód implementálása.<br><b>Tech Stack:</b> PHP 8.3, Twig, Vanilla JS, GitHub Actions (Smart Build Script)."
  ...
  - date: 2008 - Cloud Migrációig
    ...
    years: 14
    animation: fadeIn
    description: "A mai SysAdmin tudásom alapkövei (Gateway & On-Premise).<br><b>Gateway Ops:</b> ClarkConnect & ClearOS alapú router/tűzfal építése. Hálózati alapok (NAT, DHCP, Squid Proxy) és routing 'élesben', vas-közeli környezetben.<br><b>Deep Security:</b> Átállás pfSense-re (pfBlockerNG + Suricata IDS/IPS) a vállalati szintű védelemért.<br><b>Virtualization:</b> VMware ESXi klaszter üzemeltetése."
